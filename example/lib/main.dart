      ...
      if (value.code != -1) {
        ...
        TencentImSDKPlugin.v2TIMManager
          ...
          if (value.code == 0) {
            ...
            final msg =
                "创建课堂失败, 房间号：${groupId} errCode:${value.code} msg:${value.desc}";
            print(msg);
          }
        });
      }
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Expanded(child: Text("摄像头",style: TextStyle(fontSize: 14,color: Colors.black),)),
                  CupertinoSwitch(
                    onChanged: (b){
                      mCameraOpen=b;
            ...
            Container(
              ...
              child: Row(
                children: [
                  Expanded(child: Text("麦克风",style: TextStyle(fontSize: 14,color: Colors.black),)),
                  CupertinoSwitch(
                    onChanged: (b){
                      mMicOpen=b;
                      if (mMicOpen) {
