...
import com.tencent.tic.demo.KeyboardHeightObserver;
import com.tencent.tic.demo.KeyboardHeightProvider;
...
public class TICClassMainActivity extends AppCompatActivity
        implements View.OnClickListener,
        TICManager.TICMessageListener,
        TICManager.TICEventListener, KeyboardHeightObserver {
    ...
    private void initView() {
        ...
        messageInputLayout = (LinearLayout) inflater.inflate(R.layout.input_text_view, null, false);

        //发送消息
        messageInputLayout.findViewById(R.id.btn_send).setOnClickListener(this);
    ...
    public void onKeyboardHeightChanged(int height, int orientation) {
        ...
        Log.w("onKeyboardHeightChanged", "height: " + height);
        //   mBoard.onKeyboardChange(height);
        if (height > 0) {
            showInputView();
        } else {
            showInputView();
    ...
    public void showInputView() {
        ...
        FrameLayout contentLayout = findViewById(R.id.layout_content);
        FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(
                WindowManager.LayoutParams.MATCH_PARENT, WindowManager.LayoutParams.WRAP_CONTENT);
        lp.gravity = Gravity.BOTTOM;

        contentLayout.addView(messageInputLayout, lp);
    }

    public void hideInputView() {
        FrameLayout contentLayout = findViewById(R.id.layout_content);
        contentLayout.removeView(messageInputLayout);
    }
    ...
    class MySettingCallback implements TICMenuDialog.IMoreListener {
        ...
        public void onStartSnapshot() {
            ...
            snapshotInfo.path = Environment.getExternalStorageDirectory().getAbsolutePath();
        ...
        public void onTipTextInput(String textContent) {
            ...
            mBoard.setToolTypeTitle(textContent, titleStyle);
        }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_send: //发送按钮
                final String msg = ((EditText) messageInputLayout.findViewById(R.id.et_message_input)).getText().toString();
                if (!TextUtils.isEmpty(msg)) {
                    sendGroupMessage(msg);
                }
                Log.e(TAG, "btn_send textH5Status:" + textH5Status + " textH5Id:" + textH5Id);
                if (!TextUtils.isEmpty(textH5Status)) {
                    if (mBoard != null) {
                        mBoard.setTextValue(textH5Id, msg);
                    }
                }
                break;
        }
...
//                .show();
    ...
    static private class MyBoardCallback implements TEduBoardController.TEduBoardCallback {
        ...
        @Override
        public void onTEBTextComponentStatusChange(String status, String id, String value, int left, int top) {
