...
{
    [[[TICManager sharedInstance] getBoardController] addElement:url type:TEDU_BOARD_ELEMENT_CUSTOM_GRAPH];
}
...
{
    TEduBoardController* bc=[[TICManager sharedInstance] getBoardController];
